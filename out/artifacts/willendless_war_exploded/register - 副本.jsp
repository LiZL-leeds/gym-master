        ...
        <div class="content">
            <div class="login_wrapper" style="background-image:url('image/fore/main.jpg'); background-repeat: no-repeat; margin-top: 10px">
                ...
                <div class="login_content">
                    <form role="form" method="post" action="foremerregister" class="merregisterForm">
                        ...
                        <div style="margin-top: 17px;">
                            <div class="login-item form-group">
                                账号:
                                <input type="email" class="form-control" name="email" placeholder="请输入账号" required>
                            </div>
                            <div class="login-item form-group">
                                昵称:
                                <input type="text" class="form-control" name="name" placeholder="请输入4-16位字符" required  title="帐号应为4-16位">
                            </div>
                            <div class="login-item form-group">
                                密码:
