...
<div class="header-area" style="background-color: #f0f0f0; height: 55px">
    <div class="container h-100">
        <div class="h-100 d-flex justify-content-between align-items-center">
            <div class="p-2">
                <br>
                <a href="forehome"><img src="./image/fore/newlogo.png" width="250px" height="50px"></a>
            </div>

            <c:if test="${empty user}">
                <div class="p-2">
                    <a href="register.jsp" style="color: #666; text-decoration: none; font-size: 14px;font-weight: 400">用户注册</a>
                    <span>|</span>
                    <a href ="register%20-%20副本.jsp" style="color: #666; text-decoration: none;font-size: 14px;font-weight: 400">商家注册</a>
                    <span>|</span>
