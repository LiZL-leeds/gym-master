                ...
                <c:forEach items="${reserveList}" var="r">
                    ...
                    <tr class="orderListItemFirstTR">
                        ...
                        <td class="orderItemDeleteTD">
                            <a href="foredeleteReserve?rid=${r.id}" onclick="return checkDelete('${r.status}')"><span class="orderListItemDelete glyphicon glyphicon-trash"></span></a></span>
                        </td>
                    </tr>
                            ...
                            <c:if test="${st.count == 1}">
                                ...
                                <td valign="center" rowspan="${fn:length(r.reserveItemList)}" class="orderListItemNumberTD orderItemOrderInfoPartTD" width="100px">
                                    ...
                                    <c:if test="${r.status eq '审核未通过'}">
                                        <a href="foreuserReserve?rid=${r.id}" style="cursor: pointer"><span>审核未通过，点击退款</span></a>
                                    </c:if>
                                    <c:if test="${r.status eq '已退款'}">
                                        <a href="foreuserReserve?rid=${r.id}" style="cursor: pointer"><span>已成功退款</span></a>
                                    </c:if>
                                </td>
                            </c:if>
                        </tr>
